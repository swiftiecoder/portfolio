  ...
  <div class="menu" style="z-index: 1000000">
    ...
    <div class="socials">
      <!--
        ...
        -->
      <a href="https://www.linkedin.com/in/shaharyar-ahsan13/" target="_blank">
        <div class="bar">
          <img class="social-image" src="@/assets/iPhone-Icons/Linkedin.webp" />
          <u>L</u>inkedIn
        </div>
      </a>
      <a href="https://github.com/swiftiecoder/" target="_blank">
        <div class="bar">
      ...
      <a href="/files/shaharyar_acad_cv.pdf" target="_blank">
        <div class="bar">
          <img class="social-image" src="@/assets/win95Icons/resume.png" />
          <u>A</u>cademic CV
        </div>

  ...
  <div class="noticeboard-container">
    ...
    <div v-else class="updates-list">
      <div v-for="update in updates" :key="update.id"
        class="update-card mb-6 p-5 border border-gray-200 rounded-md bg-white shadow-sm">
        ...
        <div class="markdown-body text-gray-700 leading-relaxed whitespace-pre-wrap"
          v-html="parseMarkdown(update.content)"></div>
      </div>
    </div>
  </div>
</template>
...
/* Markdown specific styles to ensure it looks good within the Noticeboard */
